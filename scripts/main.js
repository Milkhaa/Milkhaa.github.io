...
const Covid19IndiaNews = "https://api.smartable.ai/coronavirus/news/"
...
function getSomeNews(countryCode){
    galleryElems = [];
    let url = Covid19IndiaNews+countryCode;
...
newsButton.onclick = function(){
    getSomeNews(document.getElementById("countries").value)
